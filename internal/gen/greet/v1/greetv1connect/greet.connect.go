...
import (
	context "context"
	errors "errors"
	v1 "github.com/adev73/goreactstreaminggrpc/internal/gen/greet/v1"
...
const (
	...
	// GreetServiceGreetingsProcedure is the fully-qualified name of the GreetService's Greetings RPC.
	GreetServiceGreetingsProcedure = "/greet.v1.GreetService/Greetings"
)
...
type GreetServiceClient interface {
	...
	Greetings(context.Context, *connect_go.Request[v1.GreetingsRequest]) (*connect_go.ServerStreamForClient[v1.GreetingsResponse], error)
}
...
func NewGreetServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) GreetServiceClient {
	...
	return &greetServiceClient{
		...
		greetings: connect_go.NewClient[v1.GreetingsRequest, v1.GreetingsResponse](
			httpClient,
			baseURL+GreetServiceGreetingsProcedure,
			opts...,
		),
	}
}
...
type greetServiceClient struct {
	...
	greetings *connect_go.Client[v1.GreetingsRequest, v1.GreetingsResponse]
}
...
// Greetings calls greet.v1.GreetService.Greetings.
func (c *greetServiceClient) Greetings(ctx context.Context, req *connect_go.Request[v1.GreetingsRequest]) (*connect_go.ServerStreamForClient[v1.GreetingsResponse], error) {
	return c.greetings.CallServerStream(ctx, req)
}

// GreetServiceHandler is an implementation of the greet.v1.GreetService service.
type GreetServiceHandler interface {
	Greet(context.Context, *connect_go.Request[v1.GreetRequest]) (*connect_go.Response[v1.GreetResponse], error)
	Greetings(context.Context, *connect_go.Request[v1.GreetingsRequest], *connect_go.ServerStream[v1.GreetingsResponse]) error
}
...
func NewGreetServiceHandler(svc GreetServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle(GreetServiceGreetingsProcedure, connect_go.NewServerStreamHandler(
		GreetServiceGreetingsProcedure,
		svc.Greetings,
		opts...,
	))
...
func (UnimplementedGreetServiceHandler) Greetings(context.Context, *connect_go.Request[v1.GreetingsRequest], *connect_go.ServerStream[v1.GreetingsResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("greet.v1.GreetService.Greetings is not implemented"))
}
